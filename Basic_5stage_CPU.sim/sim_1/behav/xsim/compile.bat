...
REM
REM Generated by Vivado on Wed Aug 27 10:52:46 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj cpu_tb_beq_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cpu_tb_beq_vlog.prj -log xvlog.log
